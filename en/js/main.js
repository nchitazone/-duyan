...
$(function() { 
  // open link post in new tab
   $('#articleInner #content a').each(function () {
        ...
        //   }
        // };
        // if(window.location.href !== 'https://laptrinhcanban.com/en'){
        //     let ran = getRandam(1, $("h2").length);
        //     n = 0;
        //     $("h2").each(function () {
        //         n += 1;
        //         if (n==ran){
        //             $path = '<div style="color:white;margin-top: -30px;margin-bottom: -20px;">'+ '<a style="color:white;" href="' +   window.location.href+ '">Source: '+window.location.href+  '</div>';
        //             $(this).after($path);
        //         }
